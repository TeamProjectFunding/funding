...
INSERT INTO QnA VALUES (QnANumber.nextval,'QnA제목','QnA내용',0,1,QnANumber.currval,0,0,sysdate,'user',null,null);
INSERT INTO QnA VALUES (QnANumber.nextval,'QnA답제목','QnA답내용',0,3,1,1,1,sysdate,null,null,'admin');
commit;
SELECT * FROM Notice;
