...
--Company 더미
INSERT INTO COMPANY VALUES ('com@naver.com', '123', 'company.png', '처음부터 끝까지 우리가 만들고 생산한다’라는 슬로건으로 만든 기업, 
...
마인드를 갖춘 영롱(TL)인더스트리는 고객의 건강과 가치 있는 삶, 풍요로운 삶에 도움이 될 수 있는 기업이 되도록 노력하겠습니다.', SYSDATE, 
