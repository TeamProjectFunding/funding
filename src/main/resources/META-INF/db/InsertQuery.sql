...
INSERT INTO FundingGoods VALUES (FundingCode.nextval,1,'펀딩상품','펀딩상품설명','상품이미지썸','상품이미지상세','펀딩설명','펀딩은행명','예금주','계좌',1000,5000,99,'2020-05-09','2020-10-10',2000,30,12,1,200,1,'admin','com');
...
INSERT INTO Notification VALUES (NOTIFICATIONNUMBER.nextval,'알림내용','2020-06-07',0,'user','admin','com');
INSERT INTO FundingGoodsDetail VALUES (FUNDINGGOODSDETAILNUMBER.nextval,2000000,'2020-05-06','2020-09-09','1','user');
