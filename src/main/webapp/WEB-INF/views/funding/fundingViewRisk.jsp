...
<body>
	...
	<section id="fundingWrap" class="fundingViewWrap">
		...
		<div id="fundingViewContentWrap"  class="riskWrap">
			<h3>투자 위험 안내</h3>
			<p>진행되는 금융투자상품에 대한 투자는 아래와 같은 투자 위험을 가지고 있습니다.<br><br>

				<h4>원금손실의 위험이 있습니다.</h4><br><br>
				<p>모든 투자는 원금손실의 위험을 가지고 있습니다. 때문에 투자 시 한 곳에만 투자하지 아니하고 다양한 상품에 분산하여 투자하실 것을 권유 드립니다.<br> 
				...
				<p>비상장기업에 대한 투자는 환금성이 낮습니다. 와디즈의 중개를 통해 모집된 증권은 6개월간 전매가 제한되며, 매매가 가능한 시점이 되더라도 현금으로의 전환이 보장되지는 않습니다.<br> 
				투자금을 회수하기 위하여 주식의 경우 스타트업 주식거래시장(KSM)에서 거래하거나, 기업의 M&A 또는 주식시장 상장 등이 있을 때까지 기다려야 할 수 있습니다. <br>
				채무증권이나 주식 관련 채권의 경우에도 특별한 사정이나 조건이 없는 한 만기까지 기다려야 합니다.</p><br><br><br>
				
				
				<h4>배당가능성이 낮습니다.</h4><br><br>
				<p>와디즈의 중개를 통해 증권을 발행하는 비상장 기업은 성장초기단계에 있는 경우가 많기 때문에, 아직 성장해야 하는 단계이기 때문에 정기 배당을 실시하는 경우가 매우 드뭅니다.<br> 
				따라서 배당수익을 기대하고 투자를 할 경우 기대한 만큼의 수익을 얻지 못할 수 있습니다.</p><br><br><br>
				
				<h4>지분 희석이 발생할 수 있습니다.</h4><br><br>
				<p>와디즈를 통하여 투자한 회사는 지속적으로 성장하기위하여 해당 기업의 정관에 근거하여 유상증자를 실시할 가능성이 높습니다. <br>
				유상증자로 인하여 투자자가 보유한 지분율은 감소될 수 있습니다.<br>
				모든 투자에는 기대수익에 상응하는 투자위험이 있음을 유의하셔야 합니다. 투자자는 투자결과에 따라 높은 수익을 얻을 수도 있지만,<br>
				원금의 100%를 손실할 가능성도 있습니다. 온라인소액투자중개서비스를 제공하는 회사로서 투자에 따른 손실 또는 그 위험을 보전해 드리지 못하며, <br>
