	...
	<section class="goodsViewWrap">
		...
		<div id="goodsViewContentWrap"  class="riskWrap">
			...
			<p>진행되는 금융투자상품에 대한 투자는 아래와 같은 투자 위험을 가지고 있습니다.<br><br>
				...
				<p>비상장기업에 대한 투자는 환금성이 낮습니다. 중개를 통해 모집된 증권은 6개월간 전매가 제한되며, 매매가 가능한 시점이 되더라도 현금으로의 전환이 보장되지는 않습니다.<br> 
				...
				<p>중개를 통해 증권을 발행하는 비상장 기업은 성장초기단계에 있는 경우가 많기 때문에, 아직 성장해야 하는 단계이기 때문에 정기 배당을 실시하는 경우가 매우 드뭅니다.<br> 
				따라서 배당수익을 기대하고 투자를 할 경우 기대한 만큼의 수익을 얻지 못할 수 있습니다.</p><br><br><br>
				
				<h4>지분 희석이 발생할 수 있습니다.</h4><br><br>
				<p>투자한 회사는 지속적으로 성장하기위하여 해당 기업의 정관에 근거하여 유상증자를 실시할 가능성이 높습니다. <br>
